...
// EmbWord1View.cpp : CEmbWord1View 类的实现
//
...
{
	// 如果所选内容只包括
	//  CEmbWord1CntrItem 对象，则以下实现就足够了。若要处理其他选择机制，
	//  则应替换此处的实现
...
CEmbWord1Doc* CEmbWord1View::GetDocument() const // 非调试版本是内联的
{

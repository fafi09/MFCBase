========================================================================
    ACTIVEX 控件 DLL : HollowBtn1 项目概述
========================================================================

控件向导已为 HollowBtn1 ActiveX 控件 DLL 创建此项目，其中包含一个控件。

此主干项目不仅演示了编写 ActiveX 
控件的基本方法，而且还可以作为编写控件特定功能的起点。

本文件概要介绍组成 HollowBtn1 ActiveX 控件 DLL 的每个文件的内容。
...
HollowBtn1Ctrl.h
    此文件包含 CHollowBtn1Ctrl C++ 类的声明。

HollowBtn1Ctrl.cpp
    此文件包含 CHollowBtn1Ctrl C++ 类的实现。

HollowBtn1PropPage.h
    此文件包含 CHollowBtn1PropPage C++ 类的声明。

HollowBtn1PropPage.cpp
    此文件包含 CHollowBtn1PropPage C++ 类的实现。

CHollowBtn1Ctrl.bmp
    此文件包含一个位图，当 CHollowBtn1Ctrl 
...
stdAfx.h，stdAfx.cpp
    这些文件用于生成名为 HollowBtn1.pch 的预编译头 (PCH) 文件和名为 

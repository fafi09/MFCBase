========================================================================
    活动模板库 : ToolHelp1 项目概述
========================================================================

应用程序向导已为您创建了此 ToolHelp1 项目，作为编写动态链接库 (DLL) 
的起点。
...
ToolHelp1.idl
    ...
    此文件将由 MIDL 编译器处理以生成：
        C++ 接口定义和 GUID 声明		(ToolHelp1.h)
        GUID 定义			(ToolHelp1_i.c)
        类型库				(ToolHelp1.tlb)
        封送处理代码			(ToolHelp1_p.c 和 
                                           dlldata.c）

ToolHelp1.h
    此文件包含 ToolHelp1.idl 中定义的项目的 C++ 接口定义
...
StdAfx.h，StdAfx.cpp
    这些文件用于生成名为 ToolHelp1.pch 的预编译头 (PCH) 文件和
...
ToolHelp1ps.vcxproj
    ...
    文件。此进程生成 dlldata.c、ToolHelp1_i.c 和 
    ToolHelp1_p.c，这些文件是生成代理/存根 (stub) DLL 所必需的。

ToolHelp1ps.vcxproj.filters
